...
dur_test_block = 2 * (n_untyp + n_typ) * dur_test / 60000; % "2 *" steht hier weil es alte + neue stimuli braucht.
...
n_target_total = n_target*blocks*n_category;
n_nontarget_total = n_nontarget*blocks*n_category;